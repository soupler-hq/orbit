...
describe('eval-runner issue #85 coverage', () => {
  ...
  it('covers the v2.9.0 contract surfaces called out in the issue', () => {
    ...
    expect(checks.get('skill contract: skills/user-onboarding.md includes VERIFICATION WORKFLOW')).toBe(
      true
    );
    ...
    expect(checks.get('workflow contract: /orbit:ship references agents')).toBe(true);
    expect(checks.get('workflow contract: /orbit:ship includes technical-writer')).toBe(true);
