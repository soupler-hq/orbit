...
Mitigations in place: `skills/prompt-safety.md`, `agents/safety-evaluator.md`, `hooks/scripts/pre-tool-use.sh` detection layer, and SHASUM manifest (in progress — see [#20](https://github.com/soupler-hq/orbit/issues/20)).
