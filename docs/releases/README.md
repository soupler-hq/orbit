...
- [release-notes.md](docs/releases/release-notes.md) is the canonical release notes document.
...
- `v<major>.<minor>.<patch>-checklist.md`
- `v<major>.<minor>.<patch>-retrospective.md`
