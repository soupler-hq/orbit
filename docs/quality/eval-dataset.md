...
| E10 | Create milestone OKRs and a roadmap for the next release phase | PRODUCT | strategist | `/orbit:plan` | Strategic planning should still route to strategist after the split |
